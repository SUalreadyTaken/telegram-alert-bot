...
public class TestAlertBot {
	...
	/**
	 * Checkprice gets the latest price from bitmex api and sets it to oldPrice field
	 */
	@Test
	...
	public void alertBot_Remove() throws IOException {
		...
		List<Update> updateList = asList(updateToSend.createUpdate(1, "/add 100"),
										 updateToSend.createUpdate(2, "/add 100"),
										 updateToSend.createUpdate(3, "/add 100"),
										 updateToSend.createUpdate(3, "/remove 100"),
	...
	/**
	 * If price to be removed from watchlist doesnt exist it still adds the price you wanted to edit it to
	 */
	@Test
	...
	/**
	 * CheckPrice adds alerts to messageToSend and deletes those entries from watchlist
	 */
	@Test
	public void checkPrice_DeletesPriceFromWatchlist() throws IOException {
		...
		List<Update> updateList = asList(updateToSend.createUpdate(1, "/add 100"),
										 updateToSend.createUpdate(2, "/add 100"),
										 updateToSend.createUpdate(3, "/add 105"),
										 updateToSend.createUpdate(4, "/add 110"),
										 updateToSend.createUpdate(5, "/add 115"),
										 updateToSend.createUpdate(6, "/add 120"));
		alertBot.onUpdatesReceived(updateList);

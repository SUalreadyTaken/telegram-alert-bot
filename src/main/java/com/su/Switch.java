...
public class Switch {
  ...
  @Autowired
  public Switch(ScheduledAnnotationBeanPostProcessor postProcessor, CheckPrice checkPrice,
      ExecuteMessages executeMessages, PreventIdling preventIdling, IdleService idleService, Init init,
